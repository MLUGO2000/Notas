 ...
 * {@link addCategoriaFragment.OnFragmentInteractionListener} interface
...
public class addCategoriaFragment extends Fragment {
    ...
    private Button buttonAgregarCat;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        editCategoria=view.findViewById(R.id.editCat);
        buttonAgregarCat=view.findViewById(R.id.b_agregarCat);

        buttonAgregarCat.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void agregarCategoria() {
        ...
        ContentValues miValues=new ContentValues();

        miValues.put(utilidades.CAMPO_CATEGORIAS_CREADAS,editCategoria.getText().toString());

        Long result= bd.insert(utilidades.TABLA_CATEGORIAS,null,miValues);

        getActivity().getSupportFragmentManager().beginTransaction().hide(getActivity().getSupportFragmentManager().findFragmentById(R.id.f_agregar)).commit();
